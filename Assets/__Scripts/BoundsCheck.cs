...
// If you type /// in Visual Studio, it will automatically expand to a <summary> (hover over game tag and this will pop up)
/// <summary>
...
public class BoundsCheck : MonoBehaviour
{
    ...
    void LateUpdate()   // LateUpdate means it is called every frame after Update to avoid a race condition
    {
