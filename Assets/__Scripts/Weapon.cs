...
/// <summary>
/// This is an enum of the vrious possible weapon types.
...
public class WeaponDefinition
{
    ...
    [Tooltip("Color of the Projetile that is fired")]
...
public class Weapon : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Find the fireEvent of a Hero Component in the parent hierarhy
    ...
    public void SetType(eWeaponType wt)
    {
        ...
        // Get the WeaponDefinition for this type of Main
