...
{
    [Header("Enemy_3 Inscirbed Fields")]
    ...
    // Again, Start works well becaues it is not used in the Enemy superclass
    void Start()
    {
        ...
        float mdiYMult = Random.Range(midpointYRange[0], midpointYRange[1]);
        points[1].y = -bndCheck.camHeight * mdiYMult;
    ...
    {
        // Bezier curves work based on a u value betwen 0 & 1
        ...
        // Enemy+3 does not call base.Move()
    }
