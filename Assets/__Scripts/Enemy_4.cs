...
public class Enemy_4 : Enemy
{
    ...
    void InitMovement()
    {
        ...
        // Make sure that it mvoes to a different quadrand of the screen
    ...
    public override void Move()
    {
        ...
        u = u - 0.15f * Mathf.Sin(u * 2 * Mathf.PI);    // Easing
        pos = (1 - u) * p0 + u * p1;
    }

    /// <summary>
    /// Enemy_4 Collisions are handled differently from other Enemy subclasses to enable protection by EnemyShields
    /// </summary>
